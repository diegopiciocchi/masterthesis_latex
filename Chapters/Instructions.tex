...
In the following, I report instructions and features concerning this \texttt{thesisclass} \LaTeX\hspace{2pt} class. As this class is based on the \texttt{memoir} class as a base, i recommend you read the manual \cite{memoirman} \footnote{\url{http://tug.ctan.org/tex-archive/macros/latex/contrib/memoir/memman.pdf}} in case you need to customize or modify the default settings. 

\section{Main Features}

The main goal of the class is to provide a customisation of \texttt{memoir} which is ready to use and fully functional typeset a thesis in Physics or Mathematics in English. With this, i have in mind the following.
...
This document was designed, tested and compiled in Linux and using bash. Therefore, if you work in the same setting, you can take advantage of the \texttt{bash} script included in the project files. The first time, you have to run
